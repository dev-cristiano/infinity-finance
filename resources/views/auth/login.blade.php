                ...
                <div class="bg-white rounded-lg shadow-lg p-8 border border-gray-100">
                    ...
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        <div class="mb-6">
                            <div class="flex justify-between items-center mb-1">
                                ...
                                <a href="{{ route('password.request') }}" class="text-xs text-yellow-600 hover:text-yellow-700">Esqueci sua senha?</a>
                            </div>
                        ...
                        <div class="flex items-center mb-6">
                            <input type="checkbox" id="remember" name="remember" class="h-4 w-4 text-yellow-500 border-gray-300 rounded focus:ring-yellow-500">
                    ...
                    <div class="text-center mt-6">
                        <p class="text-sm text-gray-600">
                            Não tem uma conta?
                            <a href="{{ route('register') }}" class="text-yellow-600 hover:text-yellow-700 font-medium">Registre se</a>
                        </p>
                    </div>
                </div>
            </div>
