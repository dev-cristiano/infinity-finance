...
<body class="bg-yellow-50/30">
    <div class="flex flex-col min-h-screen">
        ...
        <header class="sticky top-0 z-50 w-full border-b bg-white/95 backdrop-blur">
            <div class="container mx-auto px-4 flex h-16 items-center justify-between">
                ...
                <nav class="hidden md:flex gap-6">
                    ...
                    <a href="#pricing" class="text-sm font-medium hover:text-yellow-500">Pricing</a>
                    <a href="#testimonials" class="text-sm font-medium hover:text-yellow-500">Testimonials</a>
                </nav>
                <div class="flex items-center gap-4">
                    <a href="{{ route('login') }}" class="text-sm">Entrar</a>
                    <a href="{{ route('register') }}" class="bg-yellow-500 text-white px-4 py-2 rounded-lg hover:bg-yellow-600">Registrar</a>
                </div>
            </div>
        </header>
        ...
        <main class="flex-1">
            ...
            <section class="w-full py-12 md:py-24 lg:py-32 bg-yellow-50/60">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                        ...
                        <div>
                            ...
                            <div class="mt-8 flex flex-wrap gap-4">
                                <a href="{{ route('register') }}" class="bg-yellow-500 text-white px-6 py-3 rounded-lg hover:bg-yellow-600 flex items-center gap-2">
                                    Comece Agora
                ...
                <div class="container mx-auto px-4 md:px-6 text-center">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
                        <div class="p-6 border rounded-lg shadow-sm">
                            <div class="bg-yellow-100 p-3 rounded-full w-12 h-12 mx-auto flex items-center justify-center">
